                ...
                @elseif(count($post->images) == 3)
                    <div class="flex gap-0.5">
                        ...
                        <div class="w-1/2 flex flex-col gap-0.5">
                            <img src="{{ asset('storage/' . $post->images[1]) }}" alt="{{ $post->title }}"
                                class="w-full h-49.75 object-cover">
                            <img src="{{ asset('storage/' . $post->images[2]) }}" alt="{{ $post->title }}"
                                class="w-full h-49.75 object-cover">
                        </div>
                    </div>
                @else
                    <div class="flex gap-0.5">
                        ...
                        <div class="w-1/2 flex flex-col gap-0.5">
                            <img src="{{ asset('storage/' . $post->images[2]) }}" alt="{{ $post->title }}"
                                class="w-full h-49.75 object-cover">
                            <div class="relative">
                                <img src="{{ asset('storage/' . $post->images[3]) }}" alt="{{ $post->title }}"
                                    class="w-full h-49.75 object-cover">
                                @if (count($post->images) > 4)
                                    <div
                                        class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
                                        <span
                                            class="text-white text-2xl font-bold">+{{ count($post->images) - 4 }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
