                    ...
                    <div class="flex gap-6">
                        <div class="flex-1 min-w-0 space-y-6">
                            ...
                            <div
                                ...
                                <!-- Action Buttons -->
                                <div
                                    class="px-6 py-4 bg-gray-50 dark:bg-gray-750 border-t border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-6">
                                            ...
                                            <a href="#comments"
                                                ...
                                                <i
                                                    class="fas fa-comment text-lg group-hover:scale-110 transition-transform"></i>
                                            ...
                                            <button onclick="sharePost()"
                                                ...
                                                <i
                                                    class="fas fa-share-alt text-lg group-hover:scale-110 transition-transform"></i>
                                ...
                                @else
                                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                                        <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 text-center">
                                            ...
                                            <p class="text-gray-600 dark:text-gray-400 mb-3">Silakan login untuk berkomentar
                                            </p>
                                            <a href="{{ route('login') }}"
